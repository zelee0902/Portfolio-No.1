...
<title>JinStagram_styleNanda</title>
...
<h3 class="text-medium-gray display-block margin-5px-bottom alt-font">STYLENANDA</h3>
<h6 class="text-medium-gray font-weight-300 margin-20px-bottom alt-font">3CE</h6>
<p class="text-large dispaly-block pull-left font-weight-300 width-90 margin-35px-bottom">
앱으로 라벨 스캔시,나오는 랜딩페이지.<br>정품인증 시리얼 노출 및 <b>고객사 전용 유통관리 페이지</b>구축해 제품 관리에 유용.</p>
</div>
</div>
</div>
<!-- end slider item -->
...
<img src="./resources/img/stylenanda/stylenanda_landing01.jpg" alt="정품인증 " />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">stylenanda-3CE</p>
</div>
...
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">정품<br>인증</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/stylenanda/stylenanda_landing02.jpg" alt="고객사용 로그인페이지" />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">stylenanda-3CE</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">고객사<br>로그인</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/stylenanda/stylenanda_landing03.jpg" alt="유통관리 내역 확인" />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">stylenanda-3CE</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">유통관리<br>내역확인</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/stylenanda/stylenanda_landing04.jpg" alt="가품" />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">stylenanda-3CE</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
