...
<h3 class="text-medium-gray display-block margin-5px-bottom alt-font">에프앤에프</h3>
<h6 class="text-medium-gray font-weight-300 margin-20px-bottom alt-font">MLB</h6>
<p class="text-large dispaly-block pull-left font-weight-300 width-90 margin-35px-bottom">
앱으로 라벨 스캔시,나오는 랜딩페이지.<br>난수 번호 입력 후, <b>정품인증 시리얼과 <br>스캔 횟수</b>가 기입 되는 이중 보안용 랜딩페이지.</p>
</div>
</div>
</div>
<!-- end slider item -->
...
<img src="./resources/img/mlb/mlb_landing.jpg" alt="난수번호 입력" />	
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">MLB</p>
</div>
...
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">난수번호<br>입력</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/mlb/mlb_regres.jpg" alt="정품 인증 확인" />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">MLB</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">정품인증</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/mlb/mlb_uni.jpg" alt="등록 완료" style="box-shadow: rgba(41, 42, 43, 0.5) 0 2px 6px -2px;">
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">MLB</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">등록완료</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/mlb/mlb_reg.jpg" alt="타기기 스캔" style="box-shadow: rgba(41, 42, 43, 0.5) 0 2px 6px -2px;">
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">MLB</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">타기기<br>스캔</a></h4>
</div>
</div>
</div>
</div>
...
<div class="display-table-cell vertical-align-middle">
<div class="display-block position-relative">
<img src="./resources/img/mlb/mlb_expire.jpg" alt="가품" />
<p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">MLB</p>
</div>
<div class="hover-title-box padding-55px-lr width-300px sm-width-100 sm-padding-20px-lr">
<div class="separator width-50px bg-black md-display-none xs-margin-lr-auto"></div>
<h4><a class="text-white font-weight-600 alt-font text-white-hover" href="#">가품</a></h4>
</div>
</div>
</div>
</div>
